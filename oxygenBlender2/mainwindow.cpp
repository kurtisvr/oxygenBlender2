...
void MainWindow::beginWeaning(){
    /*
     * When currently run, the program will freeze after you the start button, because it's going to wait until the entire process is done before
     * it shows anything. Timer function may or may not work, couldn't check b/c you can't see output as the program is running.
     *
    */
...
//    }
    ...
    while(1){
        ...
        while(counter < timeLevel){
            counter = timer.elapsed();  //in milliseconds
